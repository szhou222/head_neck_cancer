...
# C019, C024, C142
lndata = lndata %>% filter(cancer_type %in% c("Pharynx","Orophary"))
# final cohort number = 1140
...
# overall mean of proportion of positive is 0.1636298
...
# filter for ICD-O-3 codes on primary site
# C019, C024, C142
lndata = lndata %>% filter(cancer_type == "Tonsil")
# final cohort number = 9548
